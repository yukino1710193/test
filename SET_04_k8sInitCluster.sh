...
sudo kubeadm init --apiserver-advertise-address=192.168.101.126 --control-plane-endpoint=master-node --upload-certs --apiserver-bind-port=8080 --pod-network-cidr=192.128.0.0/16
